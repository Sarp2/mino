...
import type { DomElementStyles, RectDimensions } from '@mino/models';
...
/** Pure MobX state for all canvas overlays - hover outline, selection rects, insertion indicator, inline text editor, and measurement lines. */
export class OverlayState {
    ...
    updateTextEditor = (
        ...
        const stylesChanged =
            ...
            JSON.stringify(this.textEditor.styles);
